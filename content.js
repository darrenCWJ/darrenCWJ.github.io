...
window.SITE = {
  ...
  pipelineNodes: {
    src: {
      label:   'ORIGIN',
      title:   'It started with data',
      body:    'My journey began studying data science — learning how data is ingested, handled, and turned into something useful. That foundation opened a path into exploring every technology and field where data could create real value, from government systems to trading floors.',
      tools:   ['Data Science', 'ETL', 'Exploration'],
      target:  '#systems',
    ...
    ingest: {
      ...
      body:    'I never stop upskilling — Databricks engineering, Imperial ML/AI, McKinsey Forward — each credential sharpening how I handle features, lead integrations end-to-end, and improve the products I ship.',
      tools:   ['Databricks', 'Imperial', 'McKinsey'],
      target:  '#certs',
      section: 'Verified Certs',
    },
    ai: {
      label:   'TOOLKIT',
      title:   'Skills earned by building',
      body:    'Every stage of the journey added tools to the matrix: Python and PySpark for the data layer, TypeScript for product, LLMs and agentic systems for intelligence — each graded by real production usage, not claims.',
      tools:   ['Python', 'TypeScript', 'LLMs'],
      target:  '#skills',
      section: 'Skill Matrix',
    },
    lake: {
      label:   'VALIDATE',
      title:   'Users decide, not me',
      body:    'Ideas earn their place by surviving contact with real users — 735 survey responses, three rounds of public prototype testing, and hard pivots whenever the data disagreed with my assumptions.',
      tools:   ['735 surveys', 'User testing', 'Pivots'],
      target:  '#projects',
    ...
    prod: {
      ...
      body:    'HomeTongue, HustleSG, LLM evaluation frameworks — real products deployed to real users. Shipping is where the journey proves itself: live, in production, being used.',
    ...
    hist: {
      ...
      body:    'From the GovTech data engineering trenches to AI product building — every role, milestone, and pivot is logged on the timeline, each one compounding into what I build next.',
    ...
    con: {
      ...
      body:    'Open to AI product engineering, data platform architecture, and ambitious problems worth solving. The pipeline never really ends — the next build starts with a conversation.',
